...
public class DataService
{
    ...
    public void SeedData() {
        ...
        if (ordinationer[0] == null) {
            ...
            ordinationer[0] = new PN(new DateTime(2026, 4, 10), new DateTime(2026, 4, 12), 123, lm[1]);    
            ordinationer[1] = new PN(new DateTime(2026, 4, 12), new DateTime(2026, 4, 14), 3, lm[0]);    
            ordinationer[2] = new PN(new DateTime(2026, 4, 20), new DateTime(2026, 4, 25), 5, lm[2]);    
            ordinationer[3] = new PN(new DateTime(2026, 4, 15), new DateTime(2026, 4, 18), 123, lm[1]);
            ordinationer[4] = new DagligFast(new DateTime(2026, 4, 10), new DateTime(2026, 4, 12), lm[1], 2, 0, 1, 0);
            ordinationer[5] = new DagligSkæv(new DateTime(2026, 4, 23), new DateTime(2026, 4, 24), lm[2]);
